        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl border border-dark-100/50 p-5 relative">
            <button
              ...
              className="absolute top-3 right-3 w-7 h-7 rounded-full bg-dark-100 hover:bg-dark-200 flex items-center justify-center transition-colors"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm font-semibold px-4 py-2 rounded-full hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300"
            >
