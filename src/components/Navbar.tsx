    ...
    <>
        ...
        <div className="container-max">
          <div className="flex items-center justify-between h-16 md:h-20 px-4 sm:px-6 lg:px-8">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a href="tel:+91XXXXXXXXXX" className="btn-primary text-sm py-2.5 px-5">
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            <div className="absolute inset-0 bg-dark-950/60 backdrop-blur-sm" onClick={() => setMobileOpen(false)} />
            <motion.div
              initial={{ x: '100%' }}
              animate={{ x: 0 }}
              exit={{ x: '100%' }}
              ...
              <div className="flex flex-col p-6 pt-20 gap-1">
                {navLinks.map((link, i) => (
                  <motion.a
                    ...
                    className="px-4 py-3 rounded-xl text-dark-700 hover:text-primary-500 hover:bg-primary-50 font-medium transition-colors"
                  >
                    {link.label}
                  </motion.a>
                ))}
