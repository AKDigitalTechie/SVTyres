...
import { CircleDot, AlignCenterHorizontal, Gauge, Wind, Construction, Disc3 } from 'lucide-react';
...
const services = [
  ...
  },
  {
    ...
    desc: 'Computerized wheel alignment to ensure proper handling, even wear, and maximum tyre life.',
  },
  {
    icon: Gauge,
    ...
    <section id="services" className="section-padding bg-white">
      <div className="container-max" ref={ref}>
        <div className="text-center mb-12">
          ...
          >
            From tyre replacement to wheel alignment — all your tyre needs under one roof.
          </motion.p>
        </div>
