...
const contactInfo = [
  ...
  { icon: MapPin, label: 'Address', value: 'Rajajinagar, Bangalore, Karnataka', href: 'https://maps.google.com/?q=Rajajinagar+Bangalore' },
      ...
      <div className="container-max" ref={ref}>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="rounded-2xl overflow-hidden shadow-lg border border-dark-100/50 h-full min-h-[300px]"
          >
            <iframe
